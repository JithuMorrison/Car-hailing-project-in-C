...
int main() {
  ...
  printColoredText("******************** WELCOME TO JITHU's CAB SERVICE "
                   "********************\n",
                   LIGHT_YELLOW_COLOR);
  ...
  if (cus == 1) {
    while (strcmp(ji, "yes") != 0) {
      ...
      if (book == 1) {
        ...
        if (strcmp(loc,loce)==0)
        {
          printf("Both starting and destination are same");
          break;
        }
        ...
        if (foul==0)
        {
          printf("Sorry,No Nearby drivers available, Please try later");
          break;
        }
        ...
        if (strcmp(pay, "yes") == 0) {
          ...
          if (strcmp(say, "no") == 0) {
            ...
            int date;
            scanf("%d", &date);
            printColoredText("\nPaying in advance(₹200+ discount)!\n",
                             LIGHT_CYAN_COLOR);
            printf("\n  Payment successful!\nStarting location: %s\nFinal "
                   "location: %s\nPaid amount: %.2f\n",
                   toc, loce, dis * 2.5 - (100 + (date * 2)));
            char hist[100];
            int goul = 0;
            while (goul != foul) {
              sprintf(hist, "%s.txt", dirver[goul]);
              ...
              fprintf(drivor,
                      ...
                      "of booking: %s\n",
                      toc, loce, 2.5 * dis - (100 + (date * 2)), u, gola, day);
              goul++;
              fclose(drivor);
            }
            fprintf(file,
      ...
      if (book == 6) {
        ...
        char dojo[100];
        printf("Do you want to see all customers[Enter all] or yours[Enter "
               "mine]: ");
        scanf("%s", dojo);
        if (strcmp(dojo, "all") == 0) {
          char sendor[100];
      ...
      if (book == 7) {
        ...
        if (check == 1) {
          ...
          int jolly;
          char sandy[100];
          printColoredText("Is there a person who can share ride to same location as you in this file:", LIGHT_CYAN_COLOR);
          scanf("%s",sandy);
          ...
          if (strcmp(startplace,destinat)==0)
          {
            printf("Both starting and destination are same");
          }
    ...
    while (strcmp(ji, "yes") != 0) {
      ...
      if (book == 4) {
        ...
        if (strcmp(dojo, "all") == 0) {
          ...
          scanf("%s",bendor);
          for (int ikki = 0; ikki < seeka; ikki++) {
            if (strcmp(stdriv[ikki].named,bendor)==0)
            {
            printf("%s,%s,%s,\n", stdriv[ikki].named,
